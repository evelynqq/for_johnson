$(function() {
    ...
    $("#nav").load("../Shared/_Layout.html #nav>ul");
    $("#header-bot").load("../Shared/_Layout.html #header-bot>div");
    $("#news").load("../Shared/_Layout.html #banner>#news");
    $("#un-lobby>aside").load("../Shared/_LayoutAside.html #un-lobby>aside");
    $("#footer").load("../Shared/_Layout.html #footer>div");
