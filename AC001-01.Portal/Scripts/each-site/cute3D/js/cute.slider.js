    ...
    setup: function () {
        ...
        function s(n) {
            ...
            if (document.detachEvent)
                document.detachEvent("onmousemove", e.element);
            else
                document.removeEventListener("mousemove", e.element, false)
        }
...
Cute.CircleTimer = function (e) {
    ...
    this.domElement = document.createElement("div");
    if (!Cute.FallBack.ua.browser.name) {
        Cute.FallBack.ua.browser.name = "IE";
        Cute.FallBack.ua.browser.major = "11";
    }
