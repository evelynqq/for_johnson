...
$(window).load(function() {
    ...
    var navRow = 10;
    var navRank = false;
    var navFrame = '<div class="subnav"><ol>*</ol></div>';
    var navPosition = '';
    var navMore = null;
    var navViewList = '';

    // json
    var navJson = '[{"code":"live","position":"vcode真人視訊","view":"#navLive"},{"code":"game","position":"vcode電子遊藝","view":"#navGame"},{"code":"sport","position":"name","view":"#navSport"},{"code":"lottery","position":"name","view":"#navLottery"},{"code":"board","position":"name","view":"#navBoard"}]';
